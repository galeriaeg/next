...
$sql = "SELECT * FROM tb_slider WHERE id='$idSlide'";
...
<table id="boxImagens" border="0" style="margin-bottom:5px;width:60%;">
	<tr>
		<td>
	...
	<tr>
		<td style="vertical-align:top;">
			...
			if (empty($foto_dsk)) {
				...
				echo "
					<a href='index.php?id=5.3&nomed=$foto_dsk&iddsk=$idSlide'>
					<img src='imgs/btn-excluir-anexo.jpg' alt='botao-excluir' title='Excluir imagem' style='position:absolute;z-index:10;' border='0' />
					</a>
		...
		<td style="vertical-align:top;">
			...
			if (empty($foto_mob)) {
				...
				echo "
					<a href='index.php?id=5.3&nomem=$foto_mob&idmob=$idSlide'>
					<img src='imgs/btn-excluir-anexo.jpg' alt='botao-excluir' title='Excluir imagem' style='position:absolute;z-index:10;' border='0' />
					</a>
...
<section id='div01' style="display:none;z-index:100" class="box-center">
	...
	<form name="formEdtSlide" enctype="multipart/form-data" action="index.php?id=5.4" method="POST" onSubmit="return edtSlide(this);">
		...
		<input name="" type="hidden" id="tipoUpload" value="<?php echo $idSlide; ?>" />
